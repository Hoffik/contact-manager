"""
Django settings for openwebtechnology project.
...
ALLOWED_HOSTS = ['serene-reef-99653.herokuapp.com', '127.0.0.1']
...
ROOT_URLCONF = 'openwebtechnology.urls'
...
WSGI_APPLICATION = 'openwebtechnology.wsgi.application'
